    ...
    <div class="card p-xl" style="max-width: 800px;">
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-lg">
                ...
                <p class="text-sm text-light mt-xs">Upload an icon image or SVG (Max 5MB, JPEG/PNG/GIF/SVG/WebP)</p>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary" style="padding: 0.75rem 1.5rem;">Create Service</button>
            </div>
        </form>
    </div>
@endsection