    ...
    <div class="card p-xl" style="max-width: 800px;">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-lg">
                ...
                <p class="text-sm text-light mt-xs">Upload product images (Max 5MB each, JPEG/PNG/GIF/WebP). You can select
                    multiple files.</p>
            </div>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary" style="padding: 0.75rem 1.5rem;">Create Product</button>
            </div>
        </form>
    </div>
@endsection